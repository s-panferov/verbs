...
/***/ function(module, exports, __webpack_require__) {
	...
	var bemr = __webpack_require__(3);
	...
	var WordPicker = (function (_super) {
	    __extends(WordPicker, _super);
	    function WordPicker() {
	        _super.apply(this, arguments);
	    }
	    WordPicker.prototype.render = function () {
	        var _this = this;
	        var block = bemr.block("word-picker");
	        var children = this.props.words.map(function (word, idx) {
	            if (idx == _this.props.idx) {
	                return React.DOM.input({
	                    type: 'text',
	                    autoFocus: true, onChange: function (e) { return _this.props.onChange(e.target.value); } });
	            }
	            else {
	...
	var LostScreen = (function (_super) {
	    __extends(LostScreen, _super);
	    function LostScreen() {
	        _super.apply(this, arguments);
	    }
	    LostScreen.prototype.render = function () {
	        var block = bemr.block("lost");
	        return React.DOM.div({ className: block.toString() }, "WASTED!", this.props.score);
	    };
	    return LostScreen;
	})(TypedReact.Component);
	...
	var App = (function (_super) {
	    ...
	    App.prototype.render = function () {
	        ...
	        return React.DOM.div({ className: block.toString() }, (!this.props.isLost ? [
	...
	window.turn = function turn() {
	    ...
	    var game = React.render(React.createElement(AppC, {
	        verbs: verbs,
	        idx: idx,
	        score: score,
	        isLost: isLost,
	        onChange: function (verb) {
	            var parts = targetVerb.split("/");
	            console.log(verb, parts);
	            if (parts.filter(function (item) { return item == verb; }).length) {
	                score += 1;
	                turn();
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/panferov/Workspace/my/verbs/node_modules/css-loader/index.js!/Users/panferov/Workspace/my/verbs/app.css", function() {
			var newContent = require("!!/Users/panferov/Workspace/my/verbs/node_modules/css-loader/index.js!/Users/panferov/Workspace/my/verbs/app.css");
